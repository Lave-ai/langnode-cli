...
class OpenaiClient(Node):
    def __init__(self, id: str, *, api_key: str = ""):
        super().__init__(id)
        self.parameters.update({"api_key": api_key if api_key else os.environ.get('LANGNODE_OPENAI_API_KEY')})
...
class OpenaiCompeletion(Node):
    def __init__(self, id: str, *, model_name: str, max_tokens: int, temperature: float):
        super().__init__(id)
